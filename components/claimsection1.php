            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <select class="form-control" name="name" id="name" onChange="getClaim1(this.value,<?php echo $noic;?>); ">
                                <option value="" style="text-transform: uppercase">Please Choose</option>
                                <?php
                                    $result1 = mysqli_query($conn, "SELECT * FROM `mra_staff` WHERE status != 'MANAGER'");
