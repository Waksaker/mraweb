...
$sqlp = "SELECT name, icno, bank_name, acc_no FROM mra_staff, mra_claims where icno = '$noic' and icno = noic and YEAR(date) = $year AND MONTH(date) = $month"; // SQL with parameters
...
<body onload="window.print()">
    <div class="container-fluid">
        <table id="page" style="width:100%; margin-bottom: 10px">
            <tr>
                <td><strong>LETILICA SDN BHD</strong></td>
                <td align="right"><strong>CLAIM PERIOD</strong></td>
            </tr>
            <tr>
                <td>Personal Claim - <?php echo $month2; ?>&nbsp;&nbsp;<?php echo $year; ?></td>
                <td align="right">From : 1 - <?php echo $month2; ?> - <?php echo $year; ?></td>
            </tr>
            <tr>
                <td></td>
                <td align="right">To : <?php echo $days; ?> - <?php echo $month2; ?> - <?php echo $year; ?></td>
            </tr>
        </table>
        <table>
            <tr>
        ...
        <table style="width:100%">
            <thead style="background-color: #E8E8E8">
                <tr>
                <th style="border: 2px solid; text-align: center; padding-top: 5px; padding-bottom: 5px;">NO</th>
                ...
                <th style="border: 2px solid; text-align: right; padding-bottom: 5px;">AMOUNTS</th>
                </tr>
            </thead>
            <?php
            ...
            <tbody>
                <tr>
                    <td style="border: 2px solid; text-align: center" width="10%"><?php echo $id; ?></td>
                    <td style="border: 2px solid; text-align: center" width="10%"><?php echo $date; ?></td>
                    <td style="border: 2px solid; text-align: center" width="30%"></td>
                    <td style="border: 2px solid; text-align: center" width="35%"><?php echo $purpose; ?><br><br><strong>DETAILS</strong><br><?php echo $details; ?></td>
                    <td style="border: 2px solid; text-align: right" width="15%" align="right"><?php echo number_format($amount,2); ?></td>
                </tr>
            </tbody>
            <?php } 
            ...
            <tfoot>
                <tr>
                    ...
                    <td style="text-align: right; border-bottom: 2px solid" width="15%" align="right"><strong><?php echo number_format($total_amount,2); ?></strong></td>
                </tr>
            </tfoot>
        </table>
    </div>
